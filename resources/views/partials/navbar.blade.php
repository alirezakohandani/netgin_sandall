<header class="main-header js-fixed-topbar dt-sl">
    ...
    <a href="#" class="ads-header hidden-sm" target="_blank"
        style="background-image: url({{asset('assets/img/banner/large-ads.jpg)')}}"></a>
    <!-- End ads -->
    <!-- Start topbar -->
                ...
                <ul class="list float-right hidden-sm">
                    ...
                    <li class="list-item list-item-has-children mega-menu mega-menu-col-3">
                        ...
                        <ul class="sub-menu nav">
                            ...
                            <li class="list-item">
                                <a href="#">
                                    <img src="{{asset('assets/img/theme/mega-menu.jpg')}}" alt="">
                                </a>
                            </li>
                        </ul>
                    </li>
                            ...
                            <div class="dropdown-list-icons">
                                <a href="#" class="dropdown-item">
                                    <div class="dropdown-item-icon">
                                        <img src="{{asset('assets/img/cart/01.jpg')}}" alt="">
                                    </div>
                                    <div class="mr-3">
                                        تیشرت مردانه
                                ...
                                <a href="#" class="dropdown-item">
                                    <div class="dropdown-item-icon">
                                        <img src="{{asset('assets/img/cart/02.jpg')}}" alt="">
                                    </div>
                                    <div class="mr-3">
                                        کت مردانه
